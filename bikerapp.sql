...
-- Compatible with migrate.js schema (source of truth)
-- Run:  psql -U postgres -d bikerapp -f bikerapp.sql
-- ============================================================

-- Step 1 (run separately if needed): CREATE DATABASE bikerapp;
...
CREATE TABLE IF NOT EXISTS users (
  ...
  avatar_url    TEXT,
  bio           TEXT,
  location      VARCHAR(100),   -- NOTE: 'location' not 'city'
...
CREATE TABLE IF NOT EXISTS rides (
  id               UUID        PRIMARY KEY DEFAULT uuid_generate_v4(),
  created_by       UUID        NOT NULL REFERENCES users(id) ON DELETE CASCADE,  -- host
  ...
  end_date         DATE,
  end_time         TIME,
  distance_km      NUMERIC(10,2),    -- NOTE: distance_km not total_km
  duration_hrs     NUMERIC(6,2),     -- NOTE: duration_hrs not duration
  cover_photo      TEXT,
  cover_photo_name VARCHAR(100),
  status           VARCHAR(30) DEFAULT 'upcoming'
                   CHECK (status IN ('upcoming','active','completed','cancelled')),
  ride_type        VARCHAR(20) DEFAULT 'Public'
                   CHECK (ride_type IN ('Public','Private')),  -- NOTE: ride_type not is_public
  is_paid          BOOLEAN     DEFAULT FALSE,
  entry_fee        NUMERIC(10,2)DEFAULT 0,
  max_participants INT         DEFAULT 20,
  cloned_count     INT         DEFAULT 0,
  parent_ride_id   UUID        REFERENCES rides(id),  -- for clones
...
CREATE TABLE IF NOT EXISTS ride_waypoints (
  ...
  name       VARCHAR(200)NOT NULL,
  stop_time  VARCHAR(20),       -- NOTE: stop_time not time/arrival_time
...
CREATE TABLE IF NOT EXISTS ride_weather (
  ...
  temperature NUMERIC(5,2),    -- NOTE: temperature not temp
  condition   VARCHAR(100),
  wind_kmh    NUMERIC(6,2),   -- NOTE: wind_kmh not wind
...
CREATE TABLE IF NOT EXISTS group_messages (
  ...
  text      TEXT,         -- NOTE: column is 'text' not 'message'
  image_url TEXT,
...
CREATE TABLE IF NOT EXISTS marketplace_listings (
  ...
  status           VARCHAR(20) DEFAULT 'active'
                   CHECK (status IN ('active','sold','inactive')),  -- NOTE: 'active' not TRUE/FALSE
  brand            VARCHAR(100),
  model            VARCHAR(100),
  year             INT,
  ...
  view_count       INT         DEFAULT 0,  -- NOTE: view_count not views
  created_at       TIMESTAMPTZ DEFAULT NOW(),
  updated_at       TIMESTAMPTZ DEFAULT NOW()
);
...
CREATE TABLE IF NOT EXISTS sos_alerts (
  ...
  created_at  TIMESTAMPTZ DEFAULT NOW(),
  resolved_at TIMESTAMPTZ               -- NOTE: resolved_at column exists
);
...
-- Hash (bcrypt $2a$10$): $2a$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi
...
-- NOTE: created_by (not host_id), distance_km, duration_hrs, ride_type, scenic
...
-- NOTE: stop_time (not time/arrival_time)
...
-- NOTE: temperature (not temp), wind_kmh (not wind)
...
-- NOTE: group_messages uses 'text' column not 'message'
INSERT INTO group_messages (group_id, sender_id, type, text) VALUES
  ('d0000001-0000-0000-0000-000000000001','a0000001-0000-0000-0000-000000000001','text',  'Morning ride tomorrow at 6 AM! Who''s joining?'),
  ('d0000001-0000-0000-0000-000000000001','a0000001-0000-0000-0000-000000000002','text',  'I''m in! What''s the route?'),
  ('d0000001-0000-0000-0000-000000000001','a0000001-0000-0000-0000-000000000003','text',  'Let''s take the coastal highway. It''s beautiful this time of year.'),
  ('d0000001-0000-0000-0000-000000000001','a0000001-0000-0000-0000-000000000002','text',  'Great! Meeting point: Shell petrol pump, Bandra. Don''t forget helmets!'),
  ('d0000001-0000-0000-0000-000000000001','a0000001-0000-0000-0000-000000000001','pinned','Next ride: Sunday 6AM, Bandra Shell Pump');
...
-- NOTE: status='active' (not is_active=true), view_count (not views)
